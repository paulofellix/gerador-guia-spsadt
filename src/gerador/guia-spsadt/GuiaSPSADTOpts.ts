import { A4Landscape } from '../../consts'
import { Doc } from '../../types'

export namespace GuiaSPSADTOpts {
        ...
        fields: [
          {
            ...
            x: 0,
            y: 3,
            width: A4Landscape.width - pdfOptions.margins.left - pdfOptions.margins.right + 10,
            font: 'negrito',
            fontSize: 10,
            height: 10,
          ...
          {
            fieldType: 'text',
            x: A4Landscape.width - pdfOptions.margins.left - pdfOptions.margins.right - 23,
            y: 0,
            width: 100,
            font: 'negrito',
            fontSize: 5,
          ...
          },
          {
            id: 'nrAtendimento',
            fieldType: 'text',
            x: A4Landscape.width - pdfOptions.margins.left - pdfOptions.margins.right - 71,
            y: 8,
            width: 30,
            font: 'negrito',
            fontSize: 8,
          ...
          },
          {
            id: 'nrConta',
            fieldType: 'text',
            x: A4Landscape.width - pdfOptions.margins.left - pdfOptions.margins.right - 68,
            y: 16,
            width: 30,
            font: 'negrito',
            fontSize: 8,
        ...
        fields: [
          {
            ...
            x: 0,
            y: 0,
            width: A4Landscape.width - pdfOptions.margins.left - pdfOptions.margins.right - 7,
            font: 'negrito',
            fontSize: 5,
            height: 8,
        ...
        fields: [
          {
            ...
            fieldType: 'field',
            label:
              '56 - Data de Realização de Procedimentos em Série    57 - Assinatura do Beneficiário ou Responsáve',
            width: A4Landscape.width - pdfOptions.margins.left - pdfOptions.margins.right - 10,
            fontSize: 5,
          },
        ],
