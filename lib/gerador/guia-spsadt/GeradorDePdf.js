...
const GuiaSPSADTOpts_1 = require("./GuiaSPSADTOpts");
class GeradorDePdf extends Render_1.Render {
    guia;
    constructor(guia) {
        super(GuiaSPSADTOpts_1.GuiaSPSADTOpts.doc, GuiaSPSADTOpts_1.GuiaSPSADTOpts.pdfOptions);
        this.guia = guia;
        this.fillData();
    ...
    drawProcedimentosSolicitados() {
        const procedimentosSolicitadosField = this.getField(GuiaSPSADTOpts_1.GuiaSPSADTOpts.GuiaFields['dadosSolicitacao.procedimentosSolicitados']);
    ...
    drawProcedimentosExecutados() {
        const procedimentoExecutados = this.getField(GuiaSPSADTOpts_1.GuiaSPSADTOpts.GuiaFields['procedimentosRealizados']);
    ...
    drawProfissionaisExecutantes() {
        const profissionaisExecutantes = this.getField(GuiaSPSADTOpts_1.GuiaSPSADTOpts.GuiaFields['profissionaisExecutantes']);
    ...
    drawDataRealizacaoSerie() {
        const dataRealizacaoSerie = this.getField(GuiaSPSADTOpts_1.GuiaSPSADTOpts.GuiaFields.dataRealizacaoProcedimentos);
        ...
        for (let i = 1; i <= 10; i++) {
            if (i % 2 === 0) {
                this.pdf
                    .font('normal')
                    .fontSize(5)
                    .text(`${i} - ______/______/______       _______________________`, line1X, dataRealizacaoSerie.y + 20);
                line1X += 155;
            }
            else {
                this.pdf
                    .font('normal')
                    .fontSize(5)
                    .text(`${i} - ______/______/______       _______________________`, line2X, dataRealizacaoSerie.y + 10);
                line2X += 155;
            }
        }
    }
    drawAssinaturas() {
        const assinaturaResponsavel = this.getField(GuiaSPSADTOpts_1.GuiaSPSADTOpts.GuiaFields.assinaturaResponsavelAutorizacao);
        this.pdf
            .font('normal')
            .fontSize(6)
    ...
    fillProcedimentosSolicitados() {
        if (!this.guia.dadosSolicitacao.procedimentosSolicitados)
            return;
        const procedimentosSolicitados = this.getField(GuiaSPSADTOpts_1.GuiaSPSADTOpts.GuiaFields['dadosSolicitacao.procedimentosSolicitados']);
    ...
    fillProcedimentosRealizados() {
        if (!this.guia.procedimentosRealizados)
            return;
        const procedimentosRealizados = this.getField(GuiaSPSADTOpts_1.GuiaSPSADTOpts.GuiaFields.procedimentosRealizados);
    ...
    fillProfissionaisExecutantes() {
        if (!this.guia.profissionaisExecutantes)
            return;
        const profissionaisExecutantes = this.getField(GuiaSPSADTOpts_1.GuiaSPSADTOpts.GuiaFields.profissionaisExecutantes);
        let { x: positionX, y: positionY } = profissionaisExecutantes;
        positionX += 12;
